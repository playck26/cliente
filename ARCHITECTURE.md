...
| `/minhas-turmas` | `professor-tabs` → `agenda-do-professor` \| `minhas-turmas-view` | **app do professor**. **SPEC-026** acrescentou a aba **Agenda, que é a padrão** — o pedido do Israel era que ele começasse escolhendo o DIA, não a turma. O calendário marca com um ponto os dias com **chamada pendente**: a grade ele já conhece de cabeça; o que ficou por registrar, não. O mês é calculado no fuso do clube, senão às 21h de 30/09 a tela abriria em outubro |
