...
// O ícone de quadra continua: desenha a QUADRA da próxima aula (categoria C da SPEC-053).
...
/**
 * SPEC-053/D4 — **três atalhos.** O de "Quadras" saiu: levava ao mesmo lugar
 * que "Reservar", e a Home deixa de falar em quadra (decisão 6 do Israel).
 */
const ATALHOS = [
  { href: "/reservas/nova", label: "Reservar", Icon: Plus },
    ...
    <main className="app-screen min-h-screen overflow-hidden bg-background pb-36">
      ...
      <div className="space-y-6 px-5">
        {error ? (
          ...
          <section className="relative overflow-hidden rounded-3xl bg-[var(--color-primary-strong)] p-4 text-white shadow-[var(--shadow-lift)]">
            ...
            <div className="relative z-10">
                ...
                <div className="min-w-0">
                  ...
                  <p className="mt-2 text-[15px] font-semibold text-white/78">
                    {proximaAula
                      ...
                      : "Faça sua reserva e monte seu próximo jogo."}
                  </p>
                </div>
              ...
              <Link
                href={proximaAula ? "/minhas-aulas" : "/reservas/nova"}
              ...
              >
                ...
                {proximaAula ? "Ver aula" : "Fazer reserva"}
              </Link>
            </div>
          </section>
        )}
        ...
        */}
        <section
          aria-label="Atalhos"
          className="grid grid-cols-3 gap-2 rounded-3xl bg-[var(--color-secondary-container)] px-3 py-4"
        >
