 ...
 * consumida por uma tela que só desenha o botão deixa todo iPhone sem
 * caminho de instalação, porque lá não existe botão a oferecer.
 *
...
const convite = () => screen.queryByRole("region", { name: "Instalar o PlayCK" });
