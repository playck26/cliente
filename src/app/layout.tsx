...
export const metadata: Metadata = {
   ...
   * estava ao instalar — quem adicionasse a partir do login ficaria com um
...
/**
 * SPEC-050 — `theme_color` existia **só no manifest**, e manifest não pinta
 * navegador: a barra de endereço e a barra de status do Android leem a
 * `<meta name="theme-color">`, que o Next só emite a partir deste export.
 * O valor é o mesmo do manifest de propósito — dois verdes diferentes entre a
 * barra e o app instalado seria pior que nenhum.
 */
